...
SUDO: process.env.SUDO === undefined ? '9473737373,94728722268' : process.env.SUDO,
...
NEWS_SEND_JID: process.env.NEWS_SEND_JID === undefined ? "120363242176556269@g.us" : process.env.NEWS_SEND_JID,
AUTO_NEWS_SENDER: process.env.AUTO_NEWS_SENDER === undefined ? "true" : process.env.AUTO_NEWS_SENDER,
TIKTOK_SEND_JID: process.env.TIKTOK_SEND_JID === undefined ? "120363369488627238@newsletter" : process.env.TIKTOK_SEND_JID,
